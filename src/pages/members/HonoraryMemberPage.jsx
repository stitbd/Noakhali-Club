    ...
    <>
      ...
      <div className={styles.hero}>
        ...
        <Container className={styles.heroContent}>
          <p className={styles.heroEyebrow}>Honorary member</p>
          <h1 className={styles.heroTitle}>Honorary member</h1>
...
export default HonoraryMemberPage;