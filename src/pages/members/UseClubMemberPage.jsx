    ...
    <>
      ...
      <div className={styles.hero}>
        ...
        <Container className={styles.heroContent}>
          <p className={styles.heroEyebrow}>Use club member</p>
          <h1 className={styles.heroTitle}>Use club member</h1>
...
export default UseClubMemberPage;