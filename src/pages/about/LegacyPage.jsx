          ...
          <Row className="align-items-center g-5">
            ...
            <Col lg={7}>
              <div className={styles.content}>
                ...
                <p className={styles.bio}>Welcome to Noakhali Club Dhaka Ltd (NCDL), the distinguished destination for heritage, connection, and community in the heart of the capital. Since our founding in 2014, NCDL has served as a premier social hub, dedicated to fostering the traditions and spirit of our roots while providing a sophisticated environment for our members for over a decade.</p>
