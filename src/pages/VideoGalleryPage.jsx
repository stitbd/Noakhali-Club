...
// Video data with actual video sources
// const VIDEO_ITEMS: VideoItem[] = [
//   // Events (5 videos)
//   { id: 1, category: 'Events', title: 'Annual Gala Dinner 2024', thumbnail: thumbnails['gala.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=QWwLF892mE8', duration: '2:45', year: 2024, description: 'Highlights from our spectacular annual gala' },
//   { id: 2, category: 'Events', title: 'Welcome Party Highlights', thumbnail: thumbnails['welcome.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=Linm8IurSX8', duration: '1:58', year: 2024, description: 'New members welcome celebration' },
//   { id: 3, category: 'Events', title: 'Christmas Celebration', thumbnail: thumbnails['christmas.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=vRLr-XRG1WE', duration: '3:12', year: 2023, description: 'Holiday magic at the club' },
//   { id: 4, category: 'Events', title: 'New Year Bash 2024', thumbnail: thumbnails['newyear.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=HMNO21TNlRY', duration: '2:30', year: 2024, description: 'Countdown celebration' },
//   { id: 5, category: 'Events', title: 'Club Anniversary', thumbnail: thumbnails['anniversary.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=upF1_Cjeg1w', duration: '4:02', year: 2023, description: '25 years of excellence' },
  
//   // Sports (5 videos)
//   { id: 6, category: 'Sports', title: 'Cricket Tournament Finals', thumbnail: thumbnails['cricket.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/shorts/yBPQDqB2ZcU', duration: '5:23', year: 2024, description: 'Thrilling final match highlights' },
//   { id: 7, category: 'Sports', title: 'Football Championship', thumbnail: thumbnails['football.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=iI4Mb3K_rGo', duration: '4:15', year: 2023, description: 'Goal compilation and best moments' },
//   { id: 8, category: 'Sports', title: 'Tennis Open Match', thumbnail: thumbnails['tennis.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=WjU7Mq1J1vo', duration: '3:45', year: 2024, description: 'Intense rally highlights' },
//   { id: 9, category: 'Sports', title: 'Swimming Competition', thumbnail: thumbnails['swimming.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://player.vimeo.com/external/1010000008.hd.mp4?s=xxx', duration: '2:18', year: 2023, description: 'Record-breaking performances' },
//   { id: 10, category: 'Sports', title: 'Annual Marathon', thumbnail: thumbnails['marathon.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=vRLr-XRG1WE', duration: '6:30', year: 2024, description: 'Community running event' },
  
//   // Interviews (2 bonus videos)
//   { id: 21, category: 'Interviews', title: 'Chairman\'s Vision', thumbnail: thumbnails['chairman.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=upF1_Cjeg1w', duration: '5:15', year: 2024, description: 'Future plans and initiatives' },
//   { id: 22, category: 'Interviews', title: 'Member Testimonials', thumbnail: thumbnails['testimonials.jpg'] || FALLBACK_THUMBNAIL, videoUrl: 'https://www.youtube.com/watch?v=QWwLF892mE8', duration: '3:40', year: 2024, description: 'Why members love our club' },
// ];
